...
const DiagnosticToolTest = () => {
    ...
    const getModalDimensions = () => {
        ...
        if (userState.step === 4) {
            // Roadmap State
            return 'w-[90vw] max-w-[1600px] rounded-3xl border-emerald-400/30';
        }

        // Standard State (Selector, Form, etc.)
        return 'w-[95%] max-w-2xl h-[85vh] max-h-[700px] rounded-3xl';
    };
                    ...
                    <div className="absolute z-[60] top-1/2 left-1/2 -translate-x-[135px] translate-y-[20vh] pointer-events-none transition-all duration-500 ease-out opacity-100">
                        ...
                        <div className="animate-cursor-click">
                            ...
                            <div className="relative transform rotate-[100deg]">                             
                                {/* Outer Glow Layer */}
                                <div className="absolute inset-0 bg-emerald-400 blur-[15px] opacity-40 rounded-full"></div>
                ...
                >
                    ...
                    {!isExpanded && (
                        <>
                            ...
                            <div className="absolute inset-0 bg-gradient-to-b from-white/40 to-emerald-500 opacity-100"></div>
                            {/* Moving Glint */}
                    ...
                    `}>
                        <span className="text-lg font-bold tracking-widest text-white uppercase drop-shadow-[0_2px_2px_rgba(0,0,0,0.2)] font-display">
                            Tạo lộ trình
                        </span>
                        ...
                        {userState.step > 0 && userState.step < 4 && (
                            ...
                            {[1, 2, 3].map((s) => (
                                ...
                                className={`h-1 rounded-full transition-all duration-500 ${
                                    userState.step >= s ? 'w-8 bg-emerald-400 shadow-[0_0_10px_#34d399]' : 'w-2 bg-slate-800'
                                }`}
                                />
                            ))}
                            </div>
...
export default DiagnosticToolTest;